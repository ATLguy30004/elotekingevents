...
// GET /api/webhook-test — check what's in KV right now + verify connection
// No auth needed, read-only diagnostic endpoint
...
export default async function handler(req, res) {
  ...
  const checks = {
    ...
    env_seed_secret: !!process.env.SEED_SECRET,
  };
